...
<head>
    ...
    <!-- Favicon icon -->
   <link rel="icon" type="image/png" sizes="16x16" href="{{asset('assets/back/imaages/favicon.png')}}">
    <!-- Custom CSS -->
            ...
            <div class="auth-box bg-dark border-top border-secondary">
                        ...
                        <div class="row border-top border-secondary">
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="pt-3">
                                        <button class="btn btn-info" id="to-recover" type="button"><i class="fa fa-lock me-1"></i> Olvido su contraseña?</button>
                ...
                <div id="recoverform">
                    <div class="text-center">
                        <span class="text-white">Ingrese su email debajo y nosotros le enviaremos instrucciones para recuperar su contraseña.</span>
                    </div>
                    <div class="row mt-3">
                        <!-- Form -->
                        <form class="col-12" action="index.html">
                            ...
                            <div class="row mt-3 pt-3 border-top border-secondary">
                                <div class="col-12">
                                    <a class="btn btn-success text-white" href="#" id="to-login" name="action">Regresar a inicio de Sesión</a>
                                    <button class="btn btn-info float-end" type="button" name="action">Recuperar</button>
                                </div>
                            </div>
                        </form>
                    </div>
